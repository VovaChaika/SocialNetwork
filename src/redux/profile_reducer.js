...
let initialState =  {
        posts: [
            {id: 1, message: 'Hi', likes: 3, isLiked:1},
            {id: 2, message: 'Hiiii', likes: 5545, isLiked:1},
            {id: 3, message: 'Cool', likes: 111, isLiked:1}
        ],
        profile: null,
        status: "",
    }
export const profile_reducer = (state = initialState, action) => {
    switch (action.type) {
        case ADD_POST:
            ...
            return {...state, posts: [...state.posts, {id: last, message: action.newPostText, likes: 0, isLiked: 1}]}
